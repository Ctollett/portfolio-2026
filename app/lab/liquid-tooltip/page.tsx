...
const MAX_STAGGER = 0.32;    // seconds, total sweep duration across the diagonal, entrance only
const EXIT_STAGGER = 0.12;   // seconds, total sweep duration on the way out — much quicker than the entrance
const WAVE_JITTER = 0.05;    // seconds, small per-piece randomness so the sweep isn't robotic
const CELL_DURATION = 0.11;
const EXIT_CELL_DURATION = 0.07;
